...
local bg_file = '~/Pictures/backgrounds/png_images/current.png'
local paint_bg = 'feh --bg-fill ' .. bg_file
...
return {
  ...
  run_on_start_up = {
    ...
    paint_bg,
    '/home/jboyett/.config/scripts/watch_bg',
    '/usr/bin/variety',
